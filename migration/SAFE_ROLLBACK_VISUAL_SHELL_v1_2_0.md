# HUB ASTORIE APP – v1.2.1 Safe Rollback Visual Shell

## Důvod verze
Verze v1.2.1 přepsala některé konkrétní šablony uživatelských sekcí. To mohlo způsobit ztrátu funkčních prvků, například v Kalkulačkách nebo dalších sekcích.

Tato verze je opravná:
- vrací základ na stabilní v1.2.1,
- nepřepisuje funkční šablony jednotlivých sekcí,
- doplňuje pouze bezpečnou globální vizuální vrstvu,
- zachovává sekci Partneři z v1.2.1 včetně rozdělení kontaktů a produktů,
