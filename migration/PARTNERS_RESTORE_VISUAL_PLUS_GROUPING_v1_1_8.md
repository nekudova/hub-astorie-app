# HUB ASTORIE APP – v1.2.3 Partners Restore Visual + Grouping

## Cíl opravy
Tato verze vrací vizuální koncept sekce Partneři zpět k původnímu workspace vzhledu z v1.2.3 a doplňuje pouze požadované funkční členění.
