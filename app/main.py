...
APP_VERSION = "1.3.7-new-tip-exact-visual-required-specialist-safe"
...
def version():
    return {
        ...
        "status": "v1.3.7 vychází ze stabilní v1.3.5; upraven pouze vizuál a validační tok sekce Nový TIP; TIP nelze založit bez specialisty",
    }
